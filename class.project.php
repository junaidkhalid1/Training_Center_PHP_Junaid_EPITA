...
class PROJECT
{
    ...
    public function projects()
    {
        try
        {
            ...
            $stmt = $this->conn->prepare("SELECT title FROM project)");
    ...
    function send_mail($email,$message,$subject)
    {
        ...
        $mail->Username="centertraining7@gmail.com ";
        $mail->Password="trainingtest";
        $mail->SetFrom('centertraining7@gmail.com','Training Center');
        $mail->AddReplyTo("centertraining7@gmail.com","Training Center");
